...
{
    public class Comp_SynthesizerGraphics : ThingComp
    {
        public CompProperties_SynthesizerGraphics Props => (CompProperties_SynthesizerGraphics)props;
        ...
        public override void PostDraw()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (parent is Building_Synthesizer synthesizer)
                    {
                        // if not in use by a pawn
                        if (!synthesizer.usedThisTick)
                        {
